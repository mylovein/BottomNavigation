 ...
 */
public class BBottomNavigationBehavior<V extends View> extends BVerticalScrollingBehavior<V> {
    ...
    public BBottomNavigationBehavior(int bottomNavHeight, int defaultOffset, boolean shy, boolean tablet) {
    ...
    public static <V extends View> BBottomNavigationBehavior<V> from(@NonNull V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof BBottomNavigationBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomNavigationBehavior");
        }
        return (BBottomNavigationBehavior<V>) behavior;
    }
