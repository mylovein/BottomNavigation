 ...
 */
public abstract class BVerticalScrollingBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public BVerticalScrollingBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BVerticalScrollingBehavior() {
        super();
    }
